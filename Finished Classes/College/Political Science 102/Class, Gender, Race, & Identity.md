...
Two major thinkers on the source of political identity:
...
- Workers and bourgeoisie form identities around these economic interests
	...
	- Recall the materialist vs. post materialist divide
...
- Of course, this differs from context: compare the UK to India for example
...
- On the one hand: **economic interests are fixed; an immutable reality**
	...
	- Culture can play a role but ultimately is the economic, material conditions that shape that culture.
...
### Constructivism's Strength & Weaknesses
...
- Descriptive
	...
	- Assumption is member of those group share policy preferences
- Symbolic
	- Implies that a representative symbolizes a constituency (Stokke & Selboe 2009)
		- Monarchs symbolizing a nation
		- Different from descriptive, which say representative bodies should reflect the composition of people who are being represented
- Substantive
...
- The means by which masculine and feminine actors (often men and women, but not perfectly congruent, and often individual but also structures) actively work to produce favorable gendered outcomes.

### Htun: Is Gender Like Ethnicity

Candidate quotas for cross cutting groups; seat reservation for coinciding ones
