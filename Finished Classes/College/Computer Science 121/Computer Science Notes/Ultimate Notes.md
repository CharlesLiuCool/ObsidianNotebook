...
The factorial of a positive number ${n}$ (including zero) is represented as ${n!}$ 
${n!}$ is the product of all of the positive integers less than or equal to ${n}$ (not including zero)

i.e. ${3! = 3 \times 2 \times 1 = 6}$

Below is a recursive solution to ${n!}$
